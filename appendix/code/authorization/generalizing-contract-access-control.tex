...
\input{appendix/code/authorization/generalizing-contract-access-control/interface-authority}

\input{appendix/code/authorization/generalizing-contract-access-control/interface-authorization}

\input{appendix/code/authorization/generalizing-contract-access-control/contract-guard}
